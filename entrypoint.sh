...
then 
  ...
  rm -f "$CLONE_DIR/$INPUT_DESTINATION_FOLDER/$INPUT_TARGET_DIR_NAME*.map" "$CLONE_DIR/$INPUT_DESTINATION_FOLDER/$INPUT_TARGET_DIR_NAME/*.js" "$CLONE_DIR/$INPUT_DESTINATION_FOLDER/$INPUT_TARGET_DIR_NAME/*.LICENSE.txt *.css"
